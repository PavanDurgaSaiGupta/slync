...
import { PenTool, FileText, Save, Trash2, ArrowLeft, Search, Plus, X, Folder } from 'lucide-react';
          ...
          >
            <div className="matrix-card h-full">
              ...
              <div className="space-y-2">
                <div 
                  className={`p-2 rounded cursor-pointer flex items-center ${!currentFolder ? 'bg-matrix-primary/20' : 'hover:bg-matrix-primary/10'}`}
                  onClick={clearFolder}
                >
                  <Folder size={14} className="mr-2 text-matrix-primary/70" />
                  <span className="text-matrix-primary text-sm">All Notes</span>
                </div>
                
                {folders.map((folder, index) => (
                  <div 
                    key={index}
                    className={`p-2 rounded cursor-pointer flex items-center ${currentFolder === folder ? 'bg-matrix-primary/20' : 'hover:bg-matrix-primary/10'}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {filteredNotes.length > 0 ? (
                  ...
                  >
                    ...
                    <p className="text-matrix-primary/60">No notes found</p>
                    <NeonButton 
